...
export const QuoteSection = () => {
    return (
        <section className="py-40 relative overflow-hidden bg-[#030305]">
            ...
            <div className="max-w-5xl mx-auto px-6 relative z-10">
                ...
                >
                    <div className="h-20 w-20 rounded-full bg-primary/10 flex items-center justify-center mb-12">
                        <Quote className="text-primary" size={32} />
                    </div>

                    <h2 className="text-3xl md:text-5xl lg:text-6xl font-black font-heading leading-tight mb-12 italic">
